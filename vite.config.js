  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        screenshots: [
          { src: 'logo-512.png', sizes: '512x512', type: 'image/png', form_factor: 'narrow', label: 'ON Delivery App' }
        ],
        shortcuts: [
          { name: 'Nuevo Servicio', short_name: 'Nuevo', description: 'Crear un nuevo servicio de delivery', url: '/restaurante/dashboard', icons: [{ src: 'logo-192.png', sizes: '192x192' }] }
        ],
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          },
          {
            ...
            handler: 'CacheFirst',
            options: { cacheName: 'osm-tiles-cache', expiration: { maxEntries: 100, maxAgeSeconds: 60 * 60 * 24 * 30 }, cacheableResponse: { statuses: [0, 200] } }
          },
          {
